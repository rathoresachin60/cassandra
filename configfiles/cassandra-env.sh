...
# add the new cassandra_exporter
JVM_OPTS="$JVM_OPTS -javaagent:/opt/aa/site_1.0/installs/dse-5.1.20/resources/cassandra/lib/cassandra-exporter-agent.jar=@/opt/aa/site_1.0/installs/dse-5.1.20/resources/cassandra/conf/metrics-exporter.yml"
